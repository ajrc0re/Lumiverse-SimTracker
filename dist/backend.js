...
<style>
    ...
    /* Active tab styling via radio:checked (supports up to 10 characters) */
    ...
    .pt-char-radio:nth-of-type(7):checked ~ .pt-tab-bar .pt-tab:nth-child(7),
    .pt-char-radio:nth-of-type(8):checked ~ .pt-tab-bar .pt-tab:nth-child(8),
    ...
    .pt-anal-sphincter {
        fill: none;
        stroke: color-mix(in srgb, #d946ef 60%, rgba(255,255,255,0.2) 40%);
        stroke-width: 3.5;
        stroke-linecap: round;
    }
      ...
      <div class="nw-body">
        ...
        <section class="nw-section nw-momentum" aria-label="Plot momentum">
          ...
          <div class="nw-path-grid" style="margin-top: 8px;">
            <div class="nw-path">
              <span class="nw-path-label">Path A \xB7 Default</span>
            ...
            <div class="nw-path">
              <span class="nw-path-label">Path B \xB7 Conflict</span>
              <span class="nw-path-value">
            ...
            <div class="nw-path">
              <span class="nw-path-label">Path C \xB7 Action</span>
              <span class="nw-path-value">
            ...
            <div class="nw-path">
              <span class="nw-path-label">Path D \xB7 Twist</span>
              <span class="nw-path-value">
...
spindle.permissions.onChanged(({ permission, granted, allGranted }) => {
  ...
  spindle.log.info(`Permission "${permission}" ${granted ? "granted" : "revoked"} \u2014 active: ${allGranted.join(", ") || "none"}`);
